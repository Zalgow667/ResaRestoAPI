...
export default class PlansController {
    ...
    async editPlan({ request, params, response }: HttpContext) {
    ...
    async deletePlan({ request, params, response }: HttpContext) {
    ...
    async getPlanFromRestaurantId({ request, response }: HttpContext) {
