...
export default class ServicesController {
  ...
  async createService({ request, response, params }: HttpContext) {
  ...
  async editService({ request, params, response }: HttpContext) {
    const token = request.header('Authorization')
    const restaurantId = params.id
  ...
  async deleteService({ request, params, response }: HttpContext) {
    const token = request.header('Authorization')
  ...
  async getMyServices({ request, params, response }: HttpContext) {
    const token = request.header('Authorization')
