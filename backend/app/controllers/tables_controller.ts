...
export default class TablesController {
    ...
    async createTable({ request, response }: HttpContext) {
    ...
    async editTable({ request, params, response }: HttpContext) {
    ...
    async deleteTable({ request, params, response }: HttpContext) {
        const token = request.header('Authorization')
    ...
    async getTablesFromPlanId(id_plan: number): Promise<Table[] | null> {
