...
export default class RestaurantsController {
  ...
  async createRestaurant({ request, response }: HttpContext) {
  ...
  async editRestaurant({ request, params, response }: HttpContext) {
    const token = request.header('Authorization')
  ...
  async deleteRestaurant({ request, params,  response }: HttpContext) {
    const token = request.header('Authorization')
    const restaurantId = params.id
  ...
  async getAllMyManagedRestaurant({ request, response }: HttpContext){
  ...
  async getRestaurantById({ request, response }: HttpContext) {
  ...
  async getAllRestaurant({ request, response }: HttpContext) {
